...
void bestHotel(int n, hotel *name)
{
    ...
    printf("Name of hotel=%s Stars=%d Addres=%s Number=%d Count of rooms=%d Count of Lux rooms=%d Count free rooms=%d\n",
           bestHotels[indexOfMax].name,
           bestHotels[indexOfMax].stars,
           bestHotels[indexOfMax].addr,
